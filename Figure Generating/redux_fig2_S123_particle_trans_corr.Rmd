...
summary(lm(log_dna_trans~Depth + Ocean_DNA + Oxygen_DNA + Temperature, pt_to_graph))
summary(lm(log_dna_trans~Depth + Ocean_DNA + Oxygen_DNA, pt_to_graph))

# summary(lm(log_dna_trans~Depth + Ocean_DNA + Oxygen_DNA, DNA_RNA_tara))
...
CAZpep.reg = rbind(reg1, reg2, reg3, reg5, reg6) %>%
