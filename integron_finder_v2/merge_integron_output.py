...
merged_integrons2 = merged_integrons[merged_integrons.annotation == "protein"]
merged_integrons2 = merged_integrons2[merged_integrons2.integron.str.contains("CALIN|complete")]
merged_integrons.to_csv("metagenome-integron-all.csv", index=False)

functional_integrons = merged_integrons[merged_integrons.function != "nan"]
functional_integrons.to_csv("metagenome-integron-with-COG-functions.csv", index=False)
